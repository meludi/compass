...
> Template — run `/compass:setup` to generate `.claude/CLAUDE.md` from this file.
...
<!-- Reaches both reviewers — Claude Code's built-in /code-review locally, and
     ...
     explicitly-read set as well (see references/HANDBOOK.md → Why there is no config file).

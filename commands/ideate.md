---
description: Structured brain dump → PRD — runs once per initiative, before /compass:create-stories
argument-hint: <initiative name or description>
---

# /compass:ideate — Initiative Brain Dump + PRD
...
**Output:** `.work/prds/{name}.prd.md` — ready for `/compass:setup-stack` (greenfield) or `/compass:create-stories`
...
→ Next: /compass:setup-stack (greenfield) or /compass:create-stories
```

...
| 1c | `/compass:setup-stack` _(greenfield only)_ | [→ details](COMMANDS.md#compasssetup-stack) |
| 1d | `/compass:setup-tracker` _(optional)_ | [→ details](COMMANDS.md#compasssetup-tracker) |

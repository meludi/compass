...
- Structural refactor smells — long methods, shallow modules, feature envy, primitive obsession (see `${CLAUDE_PLUGIN_ROOT}/references/HANDBOOK.md` → *Refactor candidates*)
